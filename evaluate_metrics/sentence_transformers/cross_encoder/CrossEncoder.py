...
from evaluate_metrics.sentence_transformers.util import fullname, get_device_name, import_from_string
    ...
    def predict(
        ...
        Examples:
            ::
                ...
                from evaluate_metrics.sentence_transformers import CrossEncoder
