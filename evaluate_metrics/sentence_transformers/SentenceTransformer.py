...
from .model_card import SentenceTransformerModelCardData, generate_model_card
...
"""
    ...
    def _load_module_class_from_ref(
        ...
        # If the class is from evaluate_metrics.sentence_transformers, we can directly import it,
