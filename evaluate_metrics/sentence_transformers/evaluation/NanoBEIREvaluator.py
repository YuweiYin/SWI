...
from evaluate_metrics.sentence_transformers.evaluation.InformationRetrievalEvaluator import InformationRetrievalEvaluator
from evaluate_metrics.sentence_transformers.evaluation.SentenceEvaluator import SentenceEvaluator
from evaluate_metrics.sentence_transformers.similarity_functions import SimilarityFunction
from evaluate_metrics.sentence_transformers.util import is_datasets_available
...
class NanoBEIREvaluator(SentenceEvaluator):
    ...
    Example:
        ::
            ...
            from evaluate_metrics.sentence_transformers import SentenceTransformer
            from evaluate_metrics.sentence_transformers.evaluation import NanoBEIREvaluator
