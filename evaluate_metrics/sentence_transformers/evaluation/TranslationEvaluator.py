...
from evaluate_metrics.sentence_transformers.util import pytorch_cos_sim
...
class TranslationEvaluator(SentenceEvaluator):
    ...
    Example:
        ::
            ...
            from evaluate_metrics.sentence_transformers.evaluation import TranslationEvaluator
