...
from evaluate_metrics.sentence_transformers.util import paraphrase_mining
...
class ParaphraseMiningEvaluator(SentenceEvaluator):
    ...
    Example:
        ::
            ...
            from evaluate_metrics.sentence_transformers.SentenceTransformer import SentenceTransformer
            from evaluate_metrics.sentence_transformers.evaluation import ParaphraseMiningEvaluator
