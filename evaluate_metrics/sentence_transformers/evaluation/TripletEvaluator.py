...
from evaluate_metrics.sentence_transformers.readers import InputExample
from evaluate_metrics.sentence_transformers.similarity_functions import SimilarityFunction
from evaluate_metrics.sentence_transformers.util import (
    pairwise_cos_sim,
    pairwise_dot_score,
...
class TripletEvaluator(SentenceEvaluator):
    ...
    Example:
        ::
            ...
            from evaluate_metrics.sentence_transformers.evaluation import TripletEvaluator
