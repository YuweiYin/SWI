...
class InformationRetrievalEvaluator(SentenceEvaluator):
    ...
    Example:
        ::
            ...
            from evaluate_metrics.sentence_transformers.evaluation import InformationRetrievalEvaluator
    ...
    def compute_metrices(
        ...
        # ):
        for corpus_start_idx in range(0, len(self.corpus), self.corpus_chunk_size):
