...
from evaluate_metrics.sentence_transformers import InputExample, util
...
class ContrastiveTensionLoss(nn.Module):
    ...
    Example:
        ::
            ...
            from evaluate_metrics.sentence_transformers.losses import ContrastiveTensionDataLoader
