    ...
    def __init__(
        ...
        Example:
            ::
                ...
                from evaluate_metrics.sentence_transformers import SentenceTransformer, losses
                from evaluate_metrics.sentence_transformers.datasets import DenoisingAutoEncoderDataset
