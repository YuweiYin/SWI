...
if TYPE_CHECKING:
    ...
    from evaluate_metrics.sentence_transformers.cross_encoder.CrossEncoder import CrossEncoder
...
def truncate_embeddings(embeddings: np.ndarray | torch.Tensor, truncate_dim: int | None) -> np.ndarray | torch.Tensor:
    ...
    Example:
        ...
        >>> from evaluate_metrics.sentence_transformers.util import truncate_embeddings
...
def mine_hard_negatives(
    ...
    Example:
        ...
        >>> from evaluate_metrics.sentence_transformers.util import mine_hard_negatives
        >>> from evaluate_metrics.sentence_transformers import SentenceTransformer
    ...
    if use_faiss:
        ...
        for i in range(0, len(query_embeddings), faiss_batch_size):
...
def fullname(o) -> str:
    ...
    Example:
        ...
        >>> from evaluate_metrics.sentence_transformers import SentenceTransformer
        >>> from evaluate_metrics.sentence_transformers.util import fullname
        >>> model = SentenceTransformer('all-MiniLM-L6-v2')
