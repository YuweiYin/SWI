...
from evaluate_metrics.sentence_transformers import __version__ as sentence_transformers_version
from evaluate_metrics.sentence_transformers.models import StaticEmbedding, Transformer
from evaluate_metrics.sentence_transformers.training_args import SentenceTransformerTrainingArguments
from evaluate_metrics.sentence_transformers.util import fullname, is_accelerate_available, is_datasets_available
...
if TYPE_CHECKING:
    from evaluate_metrics.sentence_transformers.evaluation.SentenceEvaluator import SentenceEvaluator
    from evaluate_metrics.sentence_transformers.SentenceTransformer import SentenceTransformer
    from evaluate_metrics.sentence_transformers.trainer import SentenceTransformerTrainer
...
class ModelCardCallback(TrainerCallback):
    ...
    def on_init_end(
        ...
        **kwargs,
        ...
        from evaluate_metrics.sentence_transformers.losses import AdaptiveLayerLoss, Matryoshka2dLoss, MatryoshkaLoss
...
"""
    ...
    def set_evaluation_metrics(
        ...
        from evaluate_metrics.sentence_transformers.evaluation import SequentialEvaluator
