...
class BatchSamplers(ExplicitEnum):
    ...
    Usage:
        ::
            ...
            from evaluate_metrics.sentence_transformers import SentenceTransformer, SentenceTransformerTrainer, SentenceTransformerTrainingArguments
            from evaluate_metrics.sentence_transformers.training_args import BatchSamplers
            from evaluate_metrics.sentence_transformers.losses import MultipleNegativesRankingLoss
...
class MultiDatasetBatchSamplers(ExplicitEnum):
    ...
    Usage:
        ::
            ...
            from evaluate_metrics.sentence_transformers import SentenceTransformer, SentenceTransformerTrainer, SentenceTransformerTrainingArguments
            from evaluate_metrics.sentence_transformers.training_args import MultiDatasetBatchSamplers
            from evaluate_metrics.sentence_transformers.losses import CoSENTLoss
