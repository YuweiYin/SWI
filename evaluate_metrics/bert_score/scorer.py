...
class BERTScorer:
    ...
    def __init__(
        ...
        self._tokenizer = get_tokenizer(self.model_type, self._use_fast_tokenizer, cache_dir=self.cache_dir)
        self._model = get_model(self.model_type, self.num_layers, self.all_layers, cache_dir=self.cache_dir)
