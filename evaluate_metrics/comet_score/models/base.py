...
from evaluate_metrics.comet_score.encoders import str2encoder
from evaluate_metrics.comet_score.modules import LayerwiseAttention
...
class CometModel(ptl.LightningModule, metaclass=abc.ABCMeta):
    ...
    def predict(
        ...
        Args:
            ...
            gpus (int): Number of gpus used for inference. Defaults to 1.
