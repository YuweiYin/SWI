...
if [[ -z ${OUTPUT_DIR} ]]; then
  OUTPUT_DIR="${PROJECT_DIR}/results/swi_gen_eval-temp_${GEN_TEMP}--arr"  # ${MODEL_NAME} is subdir
fi
...
echo -e "\n\n >>> python3 run_gen_lm.py --use_arr --eval_task_name ${EVAL_TASK_NAME} --hf_id ${MODEL}"
