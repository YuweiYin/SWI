...
class EvalTaskCommonsenseQA(EvalTaskManager):
    ...
    def __init__(
        ...
        # CommonsenseQA: Question Answering (Multiple-Choice QA)
        # Train = 9741, Validation = 1221, Test = 1140
        # Features: ["id", "question", "question_concept", "choices", "answerKey"]
        # Eval: valid set
        # >>> [use_swi = False] >>> #Sub-Tasks = 1; #Total Ins. = 1221; avg_len_token: 127.476; std_len_token: 6.634
        # >>> [use_swi = True] >>> #Sub-Tasks = 1; #Total Ins. = 1221; avg_len_token: 212.476; std_len_token: 6.634
...
4. At last, clearly and concisely give your final answer starting with "Final Answer:"
    ...
    def set_dialog(
        ...
        # Process data ["id", "question", "question_concept", "choices", "answerKey"]
        ...
        pos_a = label2index[answer_label]
