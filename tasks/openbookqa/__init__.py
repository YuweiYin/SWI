...
class EvalTaskOpenbookQA(EvalTaskManager):
    ...
    def __init__(
        ...
        # OpenBookQA: Question Answering (Multiple-Choice QA)
        # Train = 4957, Validation = 500, Test = 500
        # Features: ["id", "question_stem", "choices", "answerKey", "fact1"]
        # Eval: test set
        # >>> [use_swi = False] >>> #Sub-Tasks = 1; #Total Ins. = 500; avg_len_token: 126.864; std_len_token: 11.491
        # >>> [use_swi = True] >>> #Sub-Tasks = 1; #Total Ins. = 500; avg_len_token: 211.864; std_len_token: 11.491

        self.task_name = "openbookqa"
        self.task_info = {
            "has_passage": True,
            "hf_dataset": [  # [hf_id, subset, eval_set]
                ["allenai/openbookqa", "additional", "test"],
            ],
        }
...
4. At last, clearly and concisely give your final answer starting with "Final Answer:"
    ...
    def set_dialog(
        ...
        # Process data ["id", "question_stem", "choices", "answerKey", "fact1"]
