...
class TaskManager:
    ...
    def __init__(
        ...
        self.all_tasks = {
            ...
            "bbh", "mmlu", "mmlu_pro",  # Question Answering
    ...
    def token_stat(
        ...
        for dataset_dict in dataset_list:
            ...
            for idx, data_item in enumerate(eval_dataset):
                ...
                num_token = input_ids.data["input_ids"].size(-1)

                cur_stat.append({
                    "prompt": cur_prompt,
                    "num_char": len(cur_prompt),
                    "num_token": num_token,
                })
        ...
        self.logger.info(
            ...
            f">>> [use_swi = {use_swi}] >>> #Sub-Tasks = {len(all_stat)}; #Total Ins. = {len(all_num_token)}; "
