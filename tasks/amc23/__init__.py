...
class EvalTaskAMC23(EvalTaskManager):
    ...
    def __init__(
        ...
        # Train = 0, Valid = 0, Test = 40
        # Features: ["id", "question", "answer", "url"]
        # Eval: test set
        # >>> [use_swi = False] >>> #Sub-Tasks = 1; #Total Ins. = 40; avg_len_token: 147.575; std_len_token: 46.849
        # >>> [use_swi = True] >>> #Sub-Tasks = 1; #Total Ins. = 40; avg_len_token: 232.575; std_len_token: 46.849

        self.task_name = "amc23"
        self.task_info = {
            "hf_dataset": [  # [hf_id, subset, eval_set]
                ["math-ai/amc23", None, "test"],
            ],
        }
...
4. At last, clearly and concisely give your final answer starting with "Final Answer:"
    ...
    def set_dialog(
        ...
        # Process data ["id", "question", "answer", "url"]
