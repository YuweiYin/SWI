...
class EvalTaskAIME25(EvalTaskManager):
    ...
    def __init__(
        ...
        # Train = 0, Valid = 0, Test = 30
        # Features: ["id", "problem", "answer"]
        # Eval: test set
        # >>> [use_swi = False] >>> #Sub-Tasks = 1; #Total Ins. = 30; avg_len_token: 234.000; std_len_token: 177.680
        # >>> [use_swi = True] >>> #Sub-Tasks = 1; #Total Ins. = 30; avg_len_token: 319.000; std_len_token: 177.680
...
4. At last, clearly and concisely give your final answer starting with "Final Answer:"
    ...
    def set_dialog(
        ...
        # Process data ["id", "problem", "answer"]
