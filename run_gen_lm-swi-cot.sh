...
echo -e "SWI_VERSION: ${SWI_VERSION}"
...
if [[ -z ${OUTPUT_DIR} ]]; then
  OUTPUT_DIR="${PROJECT_DIR}/results/results--swi_cot"  # ${MODEL_NAME} is subdir
fi
...
echo -e "\n\n >>> python3 run_gen_lm.py --use_swi --use_cot --eval_task_name ${EVAL_TASK_NAME} --hf_id ${MODEL}"
